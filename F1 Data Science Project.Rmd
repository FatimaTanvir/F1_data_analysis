...
qualifying_by_year$nameChar = as.character(qualifying_by_year$name.y)
...
qualifying_by_year %>% filter(nameChar == 'Alpine F1 Team' | 
                      nameChar == 'Aston Martin' | nameChar == 'Ferrari' | 
                      nameChar =='Haas F1 Team' | nameChar == 'McLaren' | 
                      nameChar == 'Mercedes' | nameChar == 'AlphaTauri' |
                      nameChar == 'Red Bull' | nameChar == 'Sauber' |
                      nameChar == 'Williams') %>% ggplot(aes(x = year,
                                                y = average_seconds, color = 
                                                nameChar)) + geom_smooth(se = 
                                                          FALSE)+labs(
