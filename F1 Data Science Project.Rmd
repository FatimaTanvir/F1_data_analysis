...
relevant_results = left_join(x = results, y = constructors) %>% filter(name == 'Alpine' | 
                          name == 'Aston Martin' | name == 'Ferrari' | 
                          name =='Haas' | name == 'McLaren' | 
                          name == 'Mercedes' | name == 'AlphaTauri' |
                          name == 'Red Bull' | name == 'Saber' |
                          name == 'Williams')
relevant_constructors = constructors %>% filter(name == 'Alpine' | 
                          name == 'Aston Martin' | name == 'Ferrari' | 
                          name =='Haas' | name == 'McLaren' | 
                          name == 'Mercedes' | name == 'AlphaTauri' |
                          name == 'Red Bull' | name == 'Saber' |
...
qualifying_by_year %>% filter(name.y == 'Alpine' | 
                      name.y == 'Aston Martin' | name.y == 'Ferrari' | 
                      name.y =='Haas' | name.y == 'McLaren' | 
                      name.y == 'Mercedes' | name.y == 'AlphaTauri' |
                      name.y == 'Red Bull' | name.y == 'Saber' |
...
results_by_year %>% filter(name.y == 'Alpine' | 
                      name.y == 'Aston Martin' | name.y == 'Ferrari' | 
                      name.y =='Haas' | name.y == 'McLaren' | 
                      name.y == 'Mercedes' | name.y == 'AlphaTauri' |
                      name.y == 'Red Bull' | name.y == 'Saber' |
...
ggplot(constructor_wins, aes(x = year, fill = name.y)) + geom_histogram(binwidth = 2)
